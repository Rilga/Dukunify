                ...
                <div class="p-6 md:p-8 text-gray-900 space-y-6">
                    ...
                    <div>
                        ...
                        <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2 text-sm">
                            ...
                            <dt class="font-medium text-gray-500">Tanggal Selesai Aktual:</dt>
                    ...
                    @if ($booking->status == 'menunggu_pembayaran_denda')
                        <div class="mt-6 pt-6 border-t text-center">
                             <form action="{{ route('booking.payDenda', $booking) }}" method="POST" onsubmit="return confirm('Anda akan mengkonfirmasi pembayaran denda ini?');">
                                @csrf
                                <x-primary-button class="bg-red-600 hover:bg-red-700 px-8 py-3 text-base">
                    ...
                    <div class="mt-6 text-center">
                        <a href="{{ route('booking.index') }}" class="text-sm text-indigo-600 hover:text-indigo-800">&larr; Kembali ke Booking Saya</a>
                    </div>
