        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="glass-dark rounded-2xl shadow-2xl shadow-purple-900/50 border border-purple-700/30 mystical-glow overflow-hidden">
                <div class="p-6 sm:p-8 text-purple-100">
                    ...
                    <form action="{{ route('admin.dukuns.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div>
                            ...
                            <input id="kode_dukun" type="text" name="kode_dukun" value="{{ old('kode_dukun') }}" required autofocus
                        ...
                        <div class="mt-4">
                            ...
                            <input id="nama_dukun" type="text" name="nama_dukun" value="{{ old('nama_dukun') }}" required
                                   class="block mt-1 w-full bg-gray-900/50 border-purple-700/50 border focus:border-purple-500 focus:ring-purple-500 rounded-lg shadow-sm text-gray-100 placeholder-gray-500">
                        ...
                        <div class="mt-4">
                            ...
                            <input id="harga" type="number" name="harga" value="{{ old('harga') }}" required
                                   class="block mt-1 w-full bg-gray-900/50 border-purple-700/50 border focus:border-purple-500 focus:ring-purple-500 rounded-lg shadow-sm text-gray-100 placeholder-gray-500">
                        ...
                        <div class="mt-4">
                            <label for="image" class="block font-medium text-sm text-purple-300 mb-1">{{ __('Gambar Dukun') }}</label>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description" rows="4" 
                                      class="block mt-1 w-full bg-gray-900/50 border-purple-700/50 border focus:border-purple-500 focus:ring-purple-500 rounded-lg shadow-sm text-gray-100 placeholder-gray-500">{{ old('description') }}</textarea>
