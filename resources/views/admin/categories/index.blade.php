<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            {{-- Tombol Tambah Kategori (Mystical) --}}
                        ...
                        <table class="min-w-full divide-y divide-purple-900/50">
                            ...
                            <thead class="bg-gray-900/50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-purple-400 uppercase tracking-wider">Deskripsi</th>
                            ...
                            <tbody class="divide-y divide-purple-800/30">
                                @forelse ($categories as $category)
                                    <tr class="hover:bg-gray-900/50 transition-colors duration-200">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-purple-200">{{ $category->name }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-purple-400">{{ Str::limit($category->description, 50) }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('admin.categories.edit', $category->id) }}" class="text-purple-400 hover:text-purple-200 transition duration-300">Edit</a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="px-6 py-4 whitespace-nowrap text-sm text-purple-400 text-center">Belum ada data kategori.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
